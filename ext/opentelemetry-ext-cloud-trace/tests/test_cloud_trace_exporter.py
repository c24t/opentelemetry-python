...
class TestCloudTraceSpanExporter(unittest.TestCase):
        ...
        self.extracted_attributes_variety_pack = {
            "attribute_map": {
                ...
                "double_key": AttributeValue(
                    string_value={"value": "1.421", "truncated_byte_count": 0}
                ),
    ...
    def test_export(self):
        ...
        cloud_trace_spans = {
            ...
            "span_id": span_id,
            "parent_span_id": None,
            "display_name": {"value": "span_name", "truncated_byte_count": 0},
    ...
    def test_extract_status(self):
        ...
        self.assertEqual(
            _extract_status(Status(canonical_code=StatusCanonicalCode.OK)),
            {"details": None, "code": 0},
        )
        self.assertEqual(
            _extract_status(
